...
export function addMatrixNode(instance, isResult = false, position = null) {
    ...
    const nodeElement = createNodeElement(id, 'matrix', content, initialDisplayValue, isResult, position);
