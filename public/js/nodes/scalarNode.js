...
export function addScalarNode(instance, isResult = false, position = null) {
    ...
    const nodeElement = createNodeElement(id, 'scalar', content, initialDisplayValue, isResult, position);
